class MappingProvider  
  ...
  def add_response_mapping(mapping, path)
    ...
    descriptor = RKResponseDescriptor.responseDescriptorWithMapping(
      mapping,
      pathPattern: nil,
      keyPath: path,
  ...
  def add_request_mapping(mapping, path, klass)
    request_descriptor = RKRequestDescriptor.requestDescriptorWithMapping(
      mapping,
      objectClass: klass,
      rootKeyPath: path
    )
  ...
  def add_route_set(klass, collection_path, resource_path)
    get_route = RKRoute.routeWithClass(
      klass, 
      pathPattern: resource_path,
      method: RKRequestMethodGET
    )
    put_route = RKRoute.routeWithClass(
      klass, 
      pathPattern: resource_path,
      method: RKRequestMethodPUT
    )
    delete_route = RKRoute.routeWithClass(
      klass, 
      pathPattern: resource_path,
      method: RKRequestMethodDELETE
    )
    post_route = RKRoute.routeWithClass(
      klass, 
  ...
  def libro_mapping
    @libro_mapping ||= begin
      mapping = RKEntityMapping.mappingForEntityForName(
        "Libro",
  ...
  def cliente_mapping
    @cliente_mapping ||= begin
      ...
      # mapping.addPropertyMapping(RKRelationshipMapping.relationshipMappingFromKeyPath("appunti", toKeyPath:"appunti", withMapping:appunto_mapping))
      # mapping.addPropertyMapping(RKRelationshipMapping.relationshipMappingFromKeyPath("classi", toKeyPath:"classi", withMapping:classe_mapping))
      # mapping.addPropertyMapping(RKRelationshipMapping.relationshipMappingFromKeyPath("docenti", toKeyPath:"docenti", withMapping:docente_mapping))
    end
  end
    ...
    @request_appunto_mapping ||= begin     
      ...
      mapping.addPropertyMapping(
        RKRelationshipMapping.relationshipMappingFromKeyPath(
          "righe_attributes", 
          toKeyPath: "righe", 
          withMapping: request_riga_mapping
        )
      )
    end
  end
