class ImagesController < UICollectionViewController
  ...
  def viewDidLoad
    ...
    collectionView.tap do |cv|
      cv.registerClass(ImagesCell, forCellWithReuseIdentifier: IMAGES__CELL_ID)
      cv.delegate = self
      cv.dataSource = self
  ...
  def collectionView(view, cellForItemAtIndexPath: index_path)
    view.dequeueReusableCellWithReuseIdentifier(IMAGES__CELL_ID, forIndexPath: index_path).tap do |cell|
